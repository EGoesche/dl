...
train_dataset = t.utils.data.DataLoader(ChallengeDataset(train, 'train'), batch_size=100, shuffle=False)
val_dataset = t.utils.data.DataLoader(ChallengeDataset(test, 'val'), batch_size=100, shuffle=True)
